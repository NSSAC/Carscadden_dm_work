...
The transitions are not as simple in multiple IC model. In the case of full immunity, there are five states \sstate{}, \ione{}, \itwo{}, \ionetwo{}, and \rstate{}. Enumerated below are the set of possible transitions:
